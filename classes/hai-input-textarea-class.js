...
class HaiInputTextarea extends HaiInput
{
    ...
    checkValidity()
    {
        ...
        {
            return {success: false, message: `Formated text length must be shorter or same as ${this.maxLength}`};
        }
    ...
    handleInput(event)
    {
        ...
        {
            this.editor.innerHTML = this.value.replaceAll(' ', '&nbsp;');
            return {success: false};
        }

        this.value = this.editor.innerHTML.replaceAll('&nbsp;', ' ');
